...
<body>
    ...
    <div class="container-fluid text-white bg-dark" >
        <div class="container p-0">
            ...
            <nav class="navbar px-0 navbar-expand-md  navbar-dark text-white bg-dark" >
                <div class="container">
                    <!-- Brand/logo -->
                    <a class="navbar-brand" href="#">DAMOZA STORE</a>
                    ...
                    <div class="collapse navbar-collapse font-weight-semi-bold justify-content-end" id="navbarNavDropdownMenu">
                        <ul class="navbar-nav">
                            <li class="nav-item p-2">
                                <a class="nav-link btn btn-secondary" href="index.php"><i class="fa fa-cart-plus"></i> Kasir</a>
                            </li>
                            <li class="nav-item p-2">
    ...
    <div class="container my-4 text-center">
        ...
        <table class="table table-striped border mt-4 text-white bg-dark" >
            <thead class=" text-light text-white bg-dark">
                <tr class="text-left">
                    <th scope="col" colspan="4" class="border-right text-white bg-black" >
                        <h3 class="text-white bg-black" ><i class="fa fa-shopping-basket"></i> Data Keranjang <i class="fa fa-shopping-basket"></i></h3>
                    </th>
                    <th scope="col" colspan="2" class="border-right text-white bg-black">
                        <h3 class=" text-white bg-black" ><?php echo $invoiceNya; ?></h3>
                    </th>
                </tr>
            ...
            <?php if (!empty($_SESSION['invoice'])): ?>
                <tfoot>
                    <tr class="text-left text-black bg-dark">
                        <th scope="col" colspan="4" class="border-right">
                            <h5 class="text-white bg-dark">Total Bayar</h5>
                        </th>
                        <th scope="col" colspan="2">
                            <h4 class="text-white bg-dark">Rp<?php echo rp($totalBayar); ?></h4>
                        </th>
                    </tr>
                    <tr class="text-left">
                        <th scope="col" colspan="6" class="border-right">
                            <a href="reset.php" role="button" class="btn btn-lg btn-block btn-dark">SELESAI <i class="fa fa-arrow-right"></i></a>
                        </th>
                    </tr>
                </tfoot>
            <?php endif ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                        <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#tambah<?= $result['id_produk']; ?>">
                            ...
                            <div class="modal-dialog" role="document">
                                <form method="POST" action="memproses_beli_produk.php" class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-dark"><i class="fa fa-check-square-o"></i> SELESAI</button>
                                    </div>
                                </form>
                            </div>
                        </div>
