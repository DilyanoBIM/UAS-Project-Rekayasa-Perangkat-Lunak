...
<body>
    ...
    <div class="container-fluid bg-dark">
        <div class="container p-0">
            ...
            <nav class="navbar px-0 navbar-expand-md bg-dark navbar-dark">
                <div class="container">
                    <!-- Brand/logo -->
                    ...
                    <div class="collapse navbar-collapse font-weight-semi-bold justify-content-end" id="navbarNavDropdownMenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item p-2">
                                <a class="nav-link btn btn-secondary" href="data-penjualan.php"><i class="fa fa-file-text-o"></i> Data Penjualan</a>
                            </li>
                        </ul>
                    </div>
                </div>
