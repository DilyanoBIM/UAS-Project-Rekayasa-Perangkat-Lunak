...
<body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse font-weight-semi-bold justify-content-end" id="navbarNavDropdownMenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item p-2">
                                <a class="nav-link btn btn-secondary" href="rekap-data-penjualan.php"><i class="fa fa-files-o" aria-hidden="true"></i> Rekap Data Penjualan</a>
                            </li>
                            <li class="nav-item p-2">
    ...
    <div class="container my-4 text-center">
        ...
        ?>
        <div class="row">
            <div class="col-4 my-4 border py-2 text-warning border-dark shadow ">
                <div class="btn btn-block btn-dark bg-black">
                    <h3>Stok Produk</h3>
            ...
            <div class="col-12 my-4 border py-2 text-warning border-dark shadow">
                <div class="btn btn-block btn-dark bg-black">
