    ...
    <div class="container-fluid py-4">
        <div class="container py-4">
            <div class="row justify-content-center my-4 py-4">
                ...
                <form action="" method="POST" class="col-6 bg-black text-center text-light shadow rounded py-4">
                    ...
                    <div class="form-group mt-4">
                        <input type="text" name="kode" class="form-control" placeholder="Masukkan kode akses anda di sini..." autocomplete="off">
                    </div>

                    <div class="form-group mt-4">
                        <button type="submit" name="submit" class="btn btn-block btn-dark">MASUK <i class="fa fa-sign-in"></i></button>
                    </div>
