                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse font-weight-semi-bold justify-content-end" id="navbarNavDropdownMenu">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item p-2">
                                    <a class="nav-link btn btn-secondary" href="daftar-produk.php"><i class="fa fa-file-text-o" aria-hidden="true"></i> Daftar Produk</a>
                                </li>
                                <li class="nav-item p-2">
            ...
            <table class="table table-striped border">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit-produk.php?id_produk=<?php echo $result['id_produk']; ?>" class="btn btn-dark"><i class="fa fa-pencil-square-o"></i> EDIT</a>
